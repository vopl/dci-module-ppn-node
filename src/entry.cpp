...
namespace dci::module::ppn::node
{
    namespace
    {
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Daemon>(ilid)) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::node::entry_;
}
